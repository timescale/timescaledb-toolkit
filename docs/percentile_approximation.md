...
SELECT *, row_number() OVER (ORDER BY api_id, user_id, ts) as row_num
FROM raw_joined),
generated_data as MATERIALIZED (
SELECT ts + '5 min'::interval * ((((row_num * 2 - 1 + 566) * 34567) % 1000)::float / 1000) as ts,
    api_id,
    user_id,
    10 * api_id * user_id   / (1+(extract(hour FROM ts)::int % api_id)) * ((((row_num * 2 + 566) * 34567) % 1000)::float / 1000) as response_time
FROM numbered
...
-----------------------+--------+---------------+--------------
2020-01-01 00:00:00+00 | 12     | 994.594818653 | 775.44
2020-01-01 12:00:00+00 | 12     | 968.655050167 | 725.76
2020-01-01 00:00:00+00 | 11     | 856.642763385 | 652.08
2020-01-01 11:00:00+00 | 11     |  833.42180602 | 612.04
2020-01-01 22:00:00+00 | 11     | 831.093633333 | 605.44
2020-01-01 00:00:00+00 |  9     | 752.496041308 |  575.1
2020-01-01 00:00:00+00 | 10     | 731.720481928 |  553.6
2020-01-01 09:00:00+00 |  9     | 723.829816972 |  542.7
2020-01-01 18:00:00+00 |  9     | 721.387674419 | 524.88
2020-01-01 10:00:00+00 | 10     | 709.393033333 |  512.4
2020-01-01 20:00:00+00 | 10     |      706.8374 |  509.6
2020-01-01 00:00:00+00 |  8     | 623.559172414 | 465.12
2020-01-01 16:00:00+00 |  8     | 604.248266667 | 441.28
2020-01-01 08:00:00+00 |  8     | 603.696710963 | 440.96
2020-01-02 00:00:00+00 | 11     | 533.617333333 |  300.3
 ```
...
WITH points as MATERIALIZED (
    SELECT
        ...
        api_id,
        user_id,
        row_number() OVER (ORDER BY api_id, user_id, ts) as row_num
    FROM response_times
),
rand_points as (
    SELECT ts, api_id, user_id
    FROM points
    ORDER BY ((row_num * 34567) % 1000), row_num
    LIMIT 10
)
...
```output, precision(2: 7)
         bucket         | api_id |      avg      |     median
------------------------+--------+---------------+---------------
2020-01-01 05:00:00+00  |  1     | 2987.57467554 |  55.04
2020-01-01 22:00:00+00  |  1     | 2986.91291181 |  53.82
2020-01-01 13:00:00+00  |  1     | 2526.79051581 |  53.68
2020-01-01 03:00:00+00  |  1     |     2069.9496 |     54
2020-01-01 20:00:00+00  |  1     | 2069.78023333 |     54
2020-01-01 11:00:00+00  |  1     |     1608.9432 |  53.76
2020-01-01 18:00:00+00  |  1     | 1149.80200334 |  54.46
2020-01-01 01:00:00+00  |  1     | 1146.00835275 |   53.3
2020-01-01 00:00:00+00  | 12     | 994.594818653 | 775.44
2020-01-01 12:00:00+00  | 12     | 968.655050167 | 725.76
2020-01-01 00:00:00+00  | 11     | 856.642763385 | 652.08
2020-01-01 11:00:00+00  | 11     |  833.42180602 | 612.04
...
2020-01-01 16:00:00+00  |  8     | 604.248266667 | 441.28
2020-01-01 08:00:00+00  |  8     | 603.696710963 | 440.96
2020-01-01 01:00:00+00  | 12     | 509.189750416 | 390.24
 ```
