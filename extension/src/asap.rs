...
fn asap_final_inner(
    ...
    unsafe {
        in_aggregate_context(fcinfo, || {
            ...
            let interval = (end_ts - start_ts) / (values.len() - 1) as i64;
...
pub fn asap_on_timevector(
    ...
    let interval = (end_ts - start_ts) / (result.len() - 1) as i64;
...
mod tests {
    ...
    fn test_against_reference() {
        ...
        Spi::execute(|client| {
            ...
            assert_relative_eq!(result.next().unwrap()[1].value::<f64>().unwrap() as f32, 10.39);
            assert_relative_eq!(result.next().unwrap()[1].value::<f64>().unwrap() as f32, 9.29);
            assert_relative_eq!(result.next().unwrap()[1].value::<f64>().unwrap() as f32, 7.54);
            assert_relative_eq!(result.next().unwrap()[1].value::<f64>().unwrap() as f32, 7.8);
            assert_relative_eq!(result.next().unwrap()[1].value::<f64>().unwrap() as f32, 10.34);
            assert_relative_eq!(result.next().unwrap()[1].value::<f64>().unwrap() as f32, 11.01);
            assert_relative_eq!(result.next().unwrap()[1].value::<f64>().unwrap() as f32, 10.54);
            assert_relative_eq!(result.next().unwrap()[1].value::<f64>().unwrap() as f32, 8.01);
            assert_relative_eq!(result.next().unwrap()[1].value::<f64>().unwrap() as f32, 8.99);
            assert_relative_eq!(result.next().unwrap()[1].value::<f64>().unwrap() as f32, 8.73);
