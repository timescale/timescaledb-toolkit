    ...
    fn test_pipeline_fill_to() {
        Spi::connect_mut(|client| {
            ...
            assert_eq!(
                ...
                (ts:\"2020-01-02 00:00:00+00\",val:10.0),\
                (ts:\"2020-01-03 00:00:00+00\",val:20.0),\
                (ts:\"2020-01-04 00:00:00+00\",val:90.0),\
                (ts:\"2020-01-05 00:00:00+00\",val:90.0),\
                (ts:\"2020-01-06 00:00:00+00\",val:30.0),\
                (ts:\"2020-01-07 00:00:00+00\",val:30.0),\
                (ts:\"2020-01-08 00:00:00+00\",val:30.0),\
                (ts:\"2020-01-09 00:00:00+00\",val:40.0)\
            ],null_val:[0,0])"
            );
            ...
            assert_eq!(
                ...
                (ts:\"2020-01-06 00:00:00+00\",val:30.0),\
                (ts:\"2020-01-07 00:00:00+00\",val:30.0),\
                (ts:\"2020-01-08 00:00:00+00\",val:40.0),\
                (ts:\"2020-01-09 00:00:00+00\",val:40.0)\
            ],null_val:[0,0])"
            );
            ...
            assert_eq!(
                ...
                (ts:\"2020-01-01 00:00:00+00\",val:10.0),\
                (ts:\"2020-01-01 10:00:00+00\",val:10.0),\
                (ts:\"2020-01-01 20:00:00+00\",val:10.0),\
                (ts:\"2020-01-02 06:00:00+00\",val:20.0),\
                (ts:\"2020-01-02 16:00:00+00\",val:20.0),\
                (ts:\"2020-01-03 00:00:00+00\",val:20.0),\
                (ts:\"2020-01-03 10:00:00+00\",val:20.0),\
                (ts:\"2020-01-03 20:00:00+00\",val:90.0),\
                (ts:\"2020-01-04 00:00:00+00\",val:90.0),\
                (ts:\"2020-01-04 10:00:00+00\",val:90.0),\
                (ts:\"2020-01-04 20:00:00+00\",val:90.0),\
                (ts:\"2020-01-05 06:00:00+00\",val:30.0),\
                (ts:\"2020-01-05 16:00:00+00\",val:30.0),\
                (ts:\"2020-01-06 00:00:00+00\",val:30.0),\
                (ts:\"2020-01-06 10:00:00+00\",val:30.0),\
                (ts:\"2020-01-06 20:00:00+00\",val:30.0),\
                (ts:\"2020-01-07 06:00:00+00\",val:30.0),\
                (ts:\"2020-01-07 16:00:00+00\",val:40.0),\
                (ts:\"2020-01-08 02:00:00+00\",val:40.0),\
                (ts:\"2020-01-08 12:00:00+00\",val:40.0),\
                (ts:\"2020-01-08 22:00:00+00\",val:40.0),\
                (ts:\"2020-01-09 00:00:00+00\",val:40.0)\
            ],null_val:[0,0,0])"
            );
        });
