    ...
    fn test_pipeline_map_lambda() {
        Spi::connect_mut(|client| {
            ...
            assert_eq!(
                val.unwrap(),
                "(version:1,num_points:5,flags:0,internal_padding:(0,0,0),points:[\
                (ts:\"2020-01-05 00:00:00+00\",val:50.0),\
                (ts:\"2020-01-02 00:00:00+00\",val:20.0),\
                (ts:\"2020-01-04 00:00:00+00\",val:40.0),\
                (ts:\"2020-01-03 00:00:00+00\",val:30.0),\
                (ts:\"2020-01-06 00:00:00+00\",val:60.0)\
            ],null_val:[0])"
            );
        });
    }
